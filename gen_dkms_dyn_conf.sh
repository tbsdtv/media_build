...
function usage {
	echo "Usage: $0 <module_dir> <media_inst_dir> <dkms_dyn_conf> [<dkms_dyn_conf_shared>] [--help]"
    ...
    echo " <dkms_dyn_conf_shared>: optional kernel-independent copy of the"
    echo "                  dynamic config, used as fallback for new kernels."
    echo " Options:"
    echo "   --help: This text"
...
# Optional 4th argument: kernel-independent shared conf path.
